...
export type GetGroupBySlugQuery = { __typename?: 'Query', group?: { __typename?: 'Group', id: string, name: string, description: string, icon?: string | null, slug: string, type: GroupType, membersCount: number, isMember: boolean, createdAt: string, owner: { __typename?: 'PublicUser', id: string, name: string, username: string, avatar: string }, posts: Array<{ __typename?: 'Post', id: string, title: string, content: string, createdAt: string, commentsCount: number, upvotes: number, downvotes: number, userVote: VoteType, author: { __typename?: 'PublicUser', id: string, name: string, username: string, avatar: string } }> } | null };
